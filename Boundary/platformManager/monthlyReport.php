...
<div class="dashboard-content">
    <h1>Monthly Report - <?= date('F Y', strtotime($selectedYear . '-' . $selectedMonth . '-01')) ?></h1>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['top_categories'])): ?>
                    <tr>
                        <td colspan="2">No category data available for this month</td>
                    </tr>
                <?php else: ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['weekly_breakdown'])): ?>
                    <tr>
                        <td colspan="2">No booking data available for this month</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($report['weekly_breakdown'] as $week): ?>
                        <tr>
                            <td><?= htmlspecialchars($week['week_name']) ?></td>
                            <td><?= $week['booking_count'] ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['categories_usage'])): ?>
                    <tr>
                        <td colspan="3">No category usage data available for this month</td>
                    </tr>
                <?php else: ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['bookings'])): ?>
                    <tr>
                        <td colspan="2">No bookings data available for this month</td>
                    </tr>
                <?php else: ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['new_users'])): ?>
                    <tr>
                        <td colspan="2">No new user registrations for this month</td>
                    </tr>
                <?php else: ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($report['new_services'])): ?>
                    <tr>
                        <td colspan="2">No new services created for this month</td>
                    </tr>
                <?php else: ?>
